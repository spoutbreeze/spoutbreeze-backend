...
from app.models.bbb_models import BroadcasterRequest, BroadcasterResponse
...
class BroadcasterService:
    ...
    async def start_broadcasting(
        ...
        try:
            ...
            is_running = bbb_service.is_meeting_running(meeting_id)
            ...
            meeting_info = bbb_service.get_meeting_info(meeting_id, password)
