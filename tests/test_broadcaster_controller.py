...
class TestBroadcasterController:
    ...
    @pytest.mark.asyncio
    async def test_broadcaster_meeting_success(
    ...
    @pytest.mark.asyncio
    async def test_broadcaster_meeting_invalid_data(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.asyncio
    async def test_broadcaster_meeting_empty_payload(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.asyncio
    async def test_broadcaster_meeting_service_error(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.asyncio
    async def test_broadcaster_meeting_missing_stream_key(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.asyncio
    async def test_broadcaster_meeting_null_fields(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.asyncio
    async def test_broadcaster_meeting_youtube_rtmp(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.asyncio
    async def test_broadcaster_meeting_facebook_rtmp(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.asyncio
    async def test_broadcaster_meeting_nonexistent_meeting(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.asyncio
    async def test_broadcaster_meeting_malformed_json(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.asyncio
    async def test_broadcaster_meeting_extra_fields(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.asyncio
    async def test_broadcaster_meeting_missing_meeting_id(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.asyncio
    async def test_broadcaster_meeting_missing_rtmp_url(
        self, client: AsyncClient
    ):
    ...
    @pytest.mark.asyncio
    async def test_broadcaster_meeting_missing_password(
        self, client: AsyncClient
    ):
